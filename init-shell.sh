...
export APP_MONGO_URL="mongodb://kadira:uuloop01@192.168.0.119:20000/kadira_app"
export DATA_MONGO_URL="mongodb://kadira:uuloop01@192.168.0.119:20000/kadira_data"
...
# UI settings
export UI_PORT=4000
export UI_URL="http://192.168.0.46:$UI_PORT"
